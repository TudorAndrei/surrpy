...
from surrpy.execution_mixins.auth import SignInMixin

# import the mixins for operations for the connection
from surrpy.execution_mixins.create import CreateMixin
...
class SurrealDB(
    ...
    """This class is responsible for managing the connection to surrpy and managing operations on the connection."""
