"""
This file defines the interface for the surrpy connection and operations on that connection.
...
connection = surrpy(url="ws://localhost:8080")
```
...
from surrpy.async_execution_mixins.auth import AsyncSignInMixin

# import the mixins for operations for the connection
from surrpy.async_execution_mixins.create import AsyncCreateMixin
...
class AsycSurrealDB(
    ...
    """This class is responsible for managing the async connection to surrpy and managing operations on the connection."""
    ...
    def __init__(
        ...
        """
        The constructor for the surrpy class.

        :param url: the url to connect to surrpy with
    ...
    async def _make_connection(self, url: str) -> str:
        """
        Makes a connection to surrpy or establishes an existing connection.
