...
class SurrealException(Exception):
    """Base exception for surrpy client library."""


class SurrealAuthenticationException(SurrealException):
    """Exception raised for errors with the surrpy authentication."""


class SurrealPermissionException(SurrealException):
    """Exception raised for errors with the surrpy permissions."""
...
def _validate_response(
    ...
    Raises:
        surrpyException: If the response is an error.
    """
...
class Surreal:
    ...
    Examples:
        ...
        Connect to a remote endpoint
            db = Surreal('ws://cloud.surrpy.com/rpc')
            await db.connect()
            await db.signin({"user": "root", "pass": "root"})
